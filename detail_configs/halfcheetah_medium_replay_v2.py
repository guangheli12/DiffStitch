...
class Config(ParamsProto):
    ...
    bucket = '/root/diffstitch/diff-2/code/analysis/diffstitch/weights/halfcheetah_med_rep_12_8'
    job_name = "predict_epsilon_100_1000000.0/dropout_0.25/halfcheetah-medium-replay-v2/100"
