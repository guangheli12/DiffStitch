...
class Config(ParamsProto):
    ...
    bucket = '/root/diffstitch/diff-2/code/analysis/diffstitch/weights/cheetah_med_exp_11_26'
    job_name = "predict_epsilon_100_1000000.0/dropout_0.25/halfcheetah-medium-expert-v2/100"
